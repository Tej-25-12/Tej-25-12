...
**Core Focus Areas**
- Backend efficiency & system scalability
- Frontend responsiveness & usability
- Clean, maintainable, and modular codebases
...
### 📚 Currently Exploring
- Advanced React patterns with Recoil
- Performance optimization for MongoDB
- Backend API design with Node.js & Express
- JWT-based authentication
- Scroll-triggered & direction-aware UI animations
